    ...
    <>
      ...
      <div className="mt-[70px] flex mb-10">
        <div className="w-11/12 md:w-8/12  lg:w-6/12 mx-auto">
          ...
          <div className="overflow-auto text-left mt-7 ">
            ...
            <br /> <br />
            I have brought numerous projects to life, a process that has led me to learn new things and gain a deeper understanding of the web. This understanding has inspired me to conceive the idea
            of developing a web service, a project on which I am currently focused.
            <br /> <br />
